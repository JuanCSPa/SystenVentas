             ...
             <div class="form-group row">
                ...
                <div class="col-xs-6">
                  ...
                  <div class="input-group">
                    ...
                    <input type="decimal" class="form-control input-lg" id="nuevoPrecioCompra" name="nuevoPrecioCompra" min="0" placeholder="Precio de compra" required>
             ...
             <div class="form-group row">
                ...
                <div class="col-xs-6">
                  ...
                  <div class="input-group">
                    ...
                    <input type="decimal" class="form-control input-lg" id="editarPrecioCompra" name="editarPrecioCompra" min="0" required>
